...
**options** | [**Vec<models::PublicSelectedOptionResponse>**](PublicSelectedOptionResponse.md) |  | 
**options_total_nanodollar** | **i64** | Per-unit sum of the chosen options. | 
**product_id** | **String** |  | 
**quantity** | **i32** |  | 
**subtotal_nanodollar** | **i64** |  | 
**unit_price_nanodollar** | **i64** | Effective price per unit: base + variant + options, all resolved from the catalog. The request never states what a choice costs. | 
