...
**job_title** | Option<**String**> | The office or post held, kept apart from `employmentType` because a director is engaged under a delegation contract rather than employment. | [optional]
**name** | **String** |  | 
