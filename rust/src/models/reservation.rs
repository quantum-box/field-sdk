...
pub struct Reservation {
    ...
    pub bill_to: Option<Option<Box<models::ReservationBillTo>>>,
    /// Why the reservation currently in `cancelled` was cancelled. `None` both for a live reservation and for one cancelled without a stated reason; `cancelled_at` is what distinguishes those two.
    #[serde(
        rename = "cancelReason",
        default,
        with = "::serde_with::rust::double_option",
