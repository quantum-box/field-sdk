...
import type { InvoiceSourceResponse } from './InvoiceSourceResponse';
import {
    InvoiceSourceResponseFromJSON,
    InvoiceSourceResponseFromJSONTyped,
    InvoiceSourceResponseToJSON,
    InvoiceSourceResponseToJSONTyped,
} from './InvoiceSourceResponse';
...
export function InvoiceResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): InvoiceResponse {
    ...
    return {
        ...
        'sources': ((json['sources'] as Array<any>).map(InvoiceSourceResponseFromJSON)),
...
export function InvoiceResponseToJSONTyped(value?: InvoiceResponse | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'sources': ((value['sources'] as Array<any>).map(InvoiceSourceResponseToJSON)),
